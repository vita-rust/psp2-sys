...
use crate::types::{SceSize, SceUID};
...
///
/// Original screen resolution is 960x544, but the following resolutions can
/// also be supplied as width and height : 480x272, 640x368, 720x408
///
