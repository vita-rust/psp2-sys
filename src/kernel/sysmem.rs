...
extern "C" {
    ...
    pub fn sceKernelGetMemBlockInfoByAddr(base: *mut ::void, info: *mut SceKernelMemBlockInfo) -> i32;
    pub fn sceKernelGetMemBlockInfoByRange(base: *mut ::void, size: SceSize, info: *mut SceKernelMemBlockInfo) -> i32;
